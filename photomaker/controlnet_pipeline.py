...
class PhotoMakerStableDiffusionXLControlNetPipeline(StableDiffusionXLControlNetPipeline):
    ...
    def __call__(
        ...
        # 4.1 Encode input prompt without the trigger word for delayed conditioning
        ...
        # 9.1 Prepare extra step kwargs. TODO: Logic should ideally just be moved out of the pipeline
        extra_step_kwargs = self.prepare_extra_step_kwargs(generator, eta)

        # 9.2 Create tensor stating which controlnets to keep
        controlnet_keep = []
        ...
        # 9.3 Prepare added time ids & embeddings
